                                           ...
                                           failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure
{
    ...
    NSString *arg_maxResults = [NSString stringWithFormat:@"&maxResults=%lu",(unsigned long)maxResults];
    NSString *args =[NSString stringWithFormat:@"&part=id%@%@%@&videoSyndicated=any&type=video",arg_order,arg_q,arg_maxResults];
                                             ...
                                             failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure
{
    ...
    NSString *arg_order = [NSString stringWithFormat:@"&order=%@",order];
    NSString *arg_maxResults = [NSString stringWithFormat:@"&maxResults=%lu",(unsigned long)maxResults];
    NSString *args =[NSString stringWithFormat:@"&part=id&channelId=%@%@%@&videoSyndicated=any&type=video",channelId,arg_order,arg_maxResults];
